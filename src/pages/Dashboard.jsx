            ...
            <div className="h-[320px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  {/* Monochrome Tooltip */}
                  <Tooltip
                    cursor={{ fill: 'rgba(156,163,175,0.15)', radius: 12 }}
                    content={({ active, payload }) => {
                      if (active && payload?.length) {
                        const d = payload[0].payload;
                        return (
                          <div className="rounded-xl bg-gray-900 px-4 py-3 shadow-xl border border-gray-700">
                  ...
                  <defs>
                    {/* High */}
                    <linearGradient id="grayHigh" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="100%" stopColor="#CCCCCC" />
                      <stop offset="0%" stopColor="  #6B6B6B" />
                    </linearGradient>

                    {/* Medium */}
                    <linearGradient id="grayMid" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="100%" stopColor="#CCCCCC" />
                      <stop offset="0%" stopColor="#6B6B6B" />
                    </linearGradient>

                    {/* Low */}
                    <linearGradient id="grayLow" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="100%" stopColor="#CCCCCC" />
                      <stop offset="0%" stopColor="#6B6B6B" />
                    </linearGradient>
                  </defs>
                      ...
                      style={{
                        ...
                        background:
                          cat.complianceRate >= 90
                            ? 'linear-gradient(to right, #CCCCCC, #6B6B6B)'
                            : cat.complianceRate >= 75
                              ? 'linear-gradient(to right, #BFBFBF, #7A7A7A)'
                              : 'linear-gradient(to right, #A3A3A3, #525252)'
                      }}
                    >
                      {/* Soft shine overlay */}
